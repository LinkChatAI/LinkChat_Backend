...
export const generatePairingCodeForRoom = async (roomCode, userId) => {
    ...
    await redis.setex(`pairing:${pairingCode}`, PAIRING_CODE_EXPIRY_SECONDS, JSON.stringify(pairingData));
